...
if iscell(fname)
  ...
  basename = fname(1:find(fname == '.', 1) - 1);
end
...
if exist('spm_bwlabel','file')
    ...
    while ~isempty(pos)
        ...
        cimg = fillcluster(cimg, x, y, z, nextfillval); % fill the cluster
...
if saveoutputs
  hdr2 = hdr;
  hdr2.scl_slope = 1;
  write_nifti(hdr2, cimg, [basename '_clustidx.nii.gz']); % previously .img and .nii
